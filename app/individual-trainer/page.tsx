    ...
    <section className='bg-primary-300 text-white py-24 px-4 md:px-8'>
      <div className='container mx-auto max-w-3xl'>
        ...
        <p className='text-lg leading-8 mb-6'>
          Whether your goal is to lose weight, build strength,knee/hip
          replacment, or simply benefit from personalized attention, our 1-on-1
          training sessions can help you reach your goals faster. Available
          online or in-person (location dependent), our trainers are certified
          kinesiologists and exercise physiologists, ensuring expert guidance at
          all times. Single and group sessions are available.
        </p>
