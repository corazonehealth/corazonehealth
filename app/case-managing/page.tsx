...
<section className="bg-primary-300 text-white py-24 px-4 md:px-8">
  <div className="container mx-auto max-w-3xl">
    ...
    We also offer tools to track vital health information, including blood pressure (BP monitor not provided), 
    body composition, and medication logs, along with symptoms and signs. Plus, our planning techniques ensure you never miss an appointment again.
    </p>
  </div>
</section>
