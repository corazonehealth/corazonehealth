        ...
        <section className='bg-primary-300 text-white py-24 px-4 md:px-8'>
          <div className='container mx-auto max-w-3xl'>
            ...
            <p className='text-lg leading-8 mb-6'>
              Join 30-minute aerobic classes via Zoom to boost endurance and
              overall fitness. With different levels available, you can exercise
              at your own pace and in your comfort zone. Improve balance,
              coordination, and reaction time—all from the convenience of home.
            </p>
            <p className='text-lg leading-8 mb-6'>
              Stay after class for exclusive 15-minute seminars by Cora Zone
              Health, covering topics like managing angina, controlling blood
              pressure, understanding the heart&apos;s electrical system...
            </p>
